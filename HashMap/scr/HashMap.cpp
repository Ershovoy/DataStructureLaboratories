...
{
	//  аждое простое число может быть представлено в виде (6 * x - 1) и (6 * X + 1) кроме (2 и 3).
	// Ќаходим простое число ближайшее к значению capacity, и меньшее него. ќно и будет взаимно простым.
